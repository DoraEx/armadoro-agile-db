<?php
    function get_employee_link($id, $name) {
        return "<input type=<button name=\"author\" class=\"btn btn-link\" type=\"submit\" value=\"$id\" form=\"employee-form\">$name</button>";
    }
    ...
    function get_project_link($id, $name) {
        return "<form method=\"post\" action=\"/view/project/index.php\"><input type=\"hidden\" name=\"project_id\" value=\"$id\"><input name=\"project\" class=\"btn btn-link\" type=\"submit\" value=\"$name\">";        
    }
    function get_task_link($id, $name) {
        return "<button name=\"task\" class=\"btn btn-link\" type=\"submit\" value=\"$id\" form=\"task-form\">$name</button>";        
    }
